...
Block pull requests that change repository governance guidance until they carry
the `needs-human-review` label and have an independent GitHub PR approval.

## Scope

- Add a GitHub Actions pull-request gate for governed guidance paths.
...
- [ ] A PR changing governed guidance paths fails when it lacks
  `needs-human-review`.
...
- Implementation: governance human-review workflow complete
